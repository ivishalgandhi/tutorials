 ...
 *        </div>
 *
 * The widget is self-contained. Include this script once at the bottom of each lesson.
 */
...
(function () {
  ...
  const STYLES = `
    ...
    .quiz-section h3 { margin-bottom: 1.2rem; }
    .quiz {
      background: #fff;
    ...
    .quiz-option:hover:not(.answered) { background: #f0f4ff; border-color: #1a56db; }
    .quiz-option .opt-key {
      flex-shrink: 0;
      width: 1.5em;
      height: 1.5em;
